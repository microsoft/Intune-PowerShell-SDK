...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/calendars/{calendarId}/events/{eventId}/calendar/calendarView/{calendarViewId}/extensions</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.extension&quot; objects in the &quot;extensions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Calendars_Events_Calendar_CalendarView_Extensions", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.extension")]
    [ResourceIdPropertyName("extensionId")]
    [ResourceReference]
    public class Get_Me_Calendars_Events_Calendar_CalendarView_Extensions : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/calendars/{calendarId}/events/{eventId}/calendar/calendarView/{calendarViewId}/extensions/{extensionId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.extension&quot; object.</para>
    ///     <para type="description">POST ~/me/calendars/{calendarId}/events/{eventId}/calendar/calendarView/{calendarViewId}/extensions</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.extension&quot; object to the &quot;extensions&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Calendars_Events_Calendar_CalendarView_Extensions", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("microsoft.graph.extension")]
    [ResourceReference]
    public class New_Me_Calendars_Events_Calendar_CalendarView_Extensions : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.event&quot; object in the &quot;calendarView&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendars/{calendarId}/events/{eventId}/calendar/calendarView/{calendarViewId}/extensions";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.extension&quot;.</para>
    ///     <para type="description">PATCH ~/me/calendars/{calendarId}/events/{eventId}/calendar/calendarView/{calendarViewId}/extensions</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.extension&quot; object in the &quot;extensions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Calendars_Events_Calendar_CalendarView_Extensions", ConfirmImpact = ConfirmImpact.Medium)]
    [ODataType("microsoft.graph.extension")]
    [ResourceIdPropertyName("extensionId")]
    public class Update_Me_Calendars_Events_Calendar_CalendarView_Extensions : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.extension&quot; object in the &quot;extensions&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendars/{calendarId}/events/{eventId}/calendar/calendarView/{calendarViewId}/extensions/{extensionId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.extension&quot; object.</para>
    ///     <para type="description">DELETE ~/me/calendars/{calendarId}/events/{eventId}/calendar/calendarView/{calendarViewId}/extensions/extensionId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.extension&quot; object from the &quot;extensions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Calendars_Events_Calendar_CalendarView_Extensions", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.extension")]
    [ResourceIdPropertyName("extensionId")]
    public class Remove_Me_Calendars_Events_Calendar_CalendarView_Extensions : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.extension&quot; object in the &quot;extensions&quot; collection.</para>
        /// </summary>
