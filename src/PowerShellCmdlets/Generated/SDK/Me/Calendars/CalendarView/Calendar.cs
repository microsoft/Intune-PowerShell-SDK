...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/calendars/{calendarId}/calendarView/{calendarViewId}/calendar</para>
    ///     <para type="description">Retrieves the &quot;calendar&quot; object (which is of type &quot;microsoft.graph.calendar&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Calendars_CalendarView_Calendar", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.calendar")]
    [ResourceReference]
    public class Get_Me_Calendars_CalendarView_Calendar : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/calendars/{calendarId}/calendarView/{calendarViewId}/calendar";
        }
    }
}