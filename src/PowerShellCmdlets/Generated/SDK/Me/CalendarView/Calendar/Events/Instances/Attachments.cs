...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/calendarView/{calendarViewId}/calendar/events/{eventId}/instances/{instanceId}/attachments</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.attachment&quot; objects in the &quot;attachments&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_CalendarView_Calendar_Events_Instances_Attachments", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.attachment")]
    [ResourceIdPropertyName("attachmentId")]
    [ResourceReference]
    public class Get_Me_CalendarView_Calendar_Events_Instances_Attachments : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/calendarView/{calendarViewId}/calendar/events/{eventId}/instances/{instanceId}/attachments/{attachmentId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.attachment&quot; object.</para>
    ///     <para type="description">POST ~/me/calendarView/{calendarViewId}/calendar/events/{eventId}/instances/{instanceId}/attachments</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.attachment&quot; object to the &quot;attachments&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_CalendarView_Calendar_Events_Instances_Attachments", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("microsoft.graph.attachment")]
    [ResourceReference]
    public class New_Me_CalendarView_Calendar_Events_Instances_Attachments : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.event&quot; object in the &quot;instances&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/{calendarViewId}/calendar/events/{eventId}/instances/{instanceId}/attachments";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.attachment&quot; object.</para>
    ///     <para type="description">DELETE ~/me/calendarView/{calendarViewId}/calendar/events/{eventId}/instances/{instanceId}/attachments/attachmentId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.attachment&quot; object from the &quot;attachments&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_CalendarView_Calendar_Events_Instances_Attachments", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.attachment")]
    [ResourceIdPropertyName("attachmentId")]
    public class Remove_Me_CalendarView_Calendar_Events_Instances_Attachments : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.attachment&quot; object in the &quot;attachments&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/{calendarViewId}/calendar/events/{eventId}/instances/{instanceId}/attachments/{attachmentId}";
        }
    }
}