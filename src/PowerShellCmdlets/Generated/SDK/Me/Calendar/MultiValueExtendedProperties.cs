...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/calendar/multiValueExtendedProperties</para>
    ...
    /// </summary>
    [Cmdlet("Get", "Me_Calendar_MultiValueExtendedProperties", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.multiValueLegacyExtendedProperty")]
    [ResourceIdPropertyName("multiValueExtendedPropertyId")]
    [ResourceReference]
    public class Get_Me_Calendar_MultiValueExtendedProperties : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/calendar/multiValueExtendedProperties/{multiValueExtendedPropertyId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.multiValueLegacyExtendedProperty&quot; object.</para>
    ///     <para type="description">POST ~/me/calendar/multiValueExtendedProperties</para>
    ...
    /// </summary>
    [Cmdlet("New", "Me_Calendar_MultiValueExtendedProperties", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.multiValueLegacyExtendedProperty")]
    [ODataType("microsoft.graph.multiValueLegacyExtendedProperty")]
    [ResourceReference]
    public class New_Me_Calendar_MultiValueExtendedProperties : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">The &quot;value&quot; property, of type &quot;Edm.String&quot;.</para>
        ///     <para type="description">This property is on the &quot;microsoft.graph.multiValueLegacyExtendedProperty&quot; type.</para>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendar/multiValueExtendedProperties";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.multiValueLegacyExtendedProperty&quot;.</para>
    ///     <para type="description">PATCH ~/me/calendar/multiValueExtendedProperties</para>
    ...
    /// </summary>
    [Cmdlet("Update", "Me_Calendar_MultiValueExtendedProperties", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.multiValueLegacyExtendedProperty")]
    [ODataType("microsoft.graph.multiValueLegacyExtendedProperty")]
    [ResourceIdPropertyName("multiValueExtendedPropertyId")]
    public class Update_Me_Calendar_MultiValueExtendedProperties : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.multiValueLegacyExtendedProperty&quot; object in the &quot;multiValueExtendedProperties&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendar/multiValueExtendedProperties/{multiValueExtendedPropertyId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.multiValueLegacyExtendedProperty&quot; object.</para>
    ///     <para type="description">DELETE ~/me/calendar/multiValueExtendedProperties/multiValueExtendedPropertyId</para>
    ...
    /// </summary>
    [Cmdlet("Remove", "Me_Calendar_MultiValueExtendedProperties", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.multiValueLegacyExtendedProperty")]
    [ResourceIdPropertyName("multiValueExtendedPropertyId")]
    public class Remove_Me_Calendar_MultiValueExtendedProperties : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.multiValueLegacyExtendedProperty&quot; object in the &quot;multiValueExtendedProperties&quot; collection.</para>
        /// </summary>
