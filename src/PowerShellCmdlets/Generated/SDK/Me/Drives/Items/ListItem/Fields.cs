...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/listItem/fields</para>
    ///     <para type="description">Retrieves the &quot;fields&quot; object (which is of type &quot;microsoft.graph.fieldValueSet&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_Items_ListItem_Fields", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.fieldValueSet")]
    [ResourceReference]
    public class Get_Me_Drives_Items_ListItem_Fields : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/items/{itemId}/listItem/fields";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.fieldValueSet&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/listItem/fields</para>
    ///     <para type="description">Creates the &quot;fields&quot; object (which is of type &quot;microsoft.graph.fieldValueSet&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_Items_ListItem_Fields", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.fieldValueSet")]
    [ODataType("microsoft.graph.fieldValueSet")]
    [ResourceReference]
    public class New_Me_Drives_Items_ListItem_Fields : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drives/{driveId}/items/{itemId}/listItem/fields</para>
    ///     <para type="description">Updates the &quot;fields&quot; object (which is of type &quot;microsoft.graph.fieldValueSet&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_Items_ListItem_Fields", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.fieldValueSet")]
    [ODataType("microsoft.graph.fieldValueSet")]
    public class Update_Me_Drives_Items_ListItem_Fields : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drives/{driveId}/items/{itemId}/listItem/fields</para>
    ///     <para type="description">Removes the &quot;fields&quot; object (which is of type &quot;microsoft.graph.fieldValueSet&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_Items_ListItem_Fields", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.fieldValueSet")]
    public class Remove_Me_Drives_Items_ListItem_Fields : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
