...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.workbookTableColumn&quot; objects in the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_Items_Workbook_Tables_Columns", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceIdPropertyName("columnId")]
    [ResourceReference]
    public class Get_Me_Drives_Items_Workbook_Tables_Columns : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/{columnId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookTableColumn&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.workbookTableColumn&quot; object to the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_Items_Workbook_Tables_Columns", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookTableColumn")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceReference]
    public class New_Me_Drives_Items_Workbook_Tables_Columns : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.workbookTableColumn&quot;.</para>
    ///     <para type="description">PATCH ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.workbookTableColumn&quot; object in the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_Items_Workbook_Tables_Columns", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookTableColumn")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceIdPropertyName("columnId")]
    public class Update_Me_Drives_Items_Workbook_Tables_Columns : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableColumn&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/{columnId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.workbookTableColumn&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/columnId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.workbookTableColumn&quot; object from the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_Items_Workbook_Tables_Columns", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceIdPropertyName("columnId")]
    public class Remove_Me_Drives_Items_Workbook_Tables_Columns : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableColumn&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/add</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Workbook_Tables_Columns_Add", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableColumn")]
    public class Invoke_Me_Drives_Items_Workbook_Tables_Columns_Add : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/add";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/dataBodyRange</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Workbook_Tables_Columns_DataBodyRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceIdPropertyName("columnId")]
    public class Invoke_Me_Drives_Items_Workbook_Tables_Columns_DataBodyRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableColumn&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/{columnId}/dataBodyRange({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/headerRowRange</para>
    ...
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Workbook_Tables_Columns_HeaderRowRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceIdPropertyName("columnId")]
    public class Invoke_Me_Drives_Items_Workbook_Tables_Columns_HeaderRowRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableColumn&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/{columnId}/headerRowRange({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/range</para>
    ...
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Workbook_Tables_Columns_Range", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceIdPropertyName("columnId")]
    public class Invoke_Me_Drives_Items_Workbook_Tables_Columns_Range : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableColumn&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/{columnId}/range({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/totalRowRange</para>
    ...
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Workbook_Tables_Columns_TotalRowRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    [ResourceIdPropertyName("columnId")]
    public class Invoke_Me_Drives_Items_Workbook_Tables_Columns_TotalRowRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableColumn&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/{columnId}/totalRowRange({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/itemAt</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Workbook_Tables_Columns_ItemAt", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    public class Invoke_Me_Drives_Items_Workbook_Tables_Columns_ItemAt : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/itemAt({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/count</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Workbook_Tables_Columns_Count", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableColumn")]
    public class Invoke_Me_Drives_Items_Workbook_Tables_Columns_Count : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/workbook/tables/{tableId}/columns/count({this.GetFunctionUrlSegment()})";
        }
    }
}