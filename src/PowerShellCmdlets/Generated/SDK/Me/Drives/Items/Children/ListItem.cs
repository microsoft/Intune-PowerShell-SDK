...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/children/{childId}/listItem</para>
    ///     <para type="description">Retrieves the &quot;listItem&quot; object (which is of type &quot;microsoft.graph.listItem&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_Items_Children_ListItem", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.listItem")]
    [ResourceReference]
    public class Get_Me_Drives_Items_Children_ListItem : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/items/{itemId}/children/{childId}/listItem";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.listItem&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/children/{childId}/listItem</para>
    ///     <para type="description">Creates the &quot;listItem&quot; object (which is of type &quot;microsoft.graph.listItem&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_Items_Children_ListItem", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.listItem")]
    [ODataType("microsoft.graph.listItem")]
    [ResourceReference]
    public class New_Me_Drives_Items_Children_ListItem : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drives/{driveId}/items/{itemId}/children/{childId}/listItem</para>
    ///     <para type="description">Updates the &quot;listItem&quot; object (which is of type &quot;microsoft.graph.listItem&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_Items_Children_ListItem", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.listItem")]
    [ODataType("microsoft.graph.listItem")]
    public class Update_Me_Drives_Items_Children_ListItem : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drives/{driveId}/items/{itemId}/children/{childId}/listItem</para>
    ///     <para type="description">Removes the &quot;listItem&quot; object (which is of type &quot;microsoft.graph.listItem&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_Items_Children_ListItem", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.listItem")]
    public class Remove_Me_Drives_Items_Children_ListItem : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
