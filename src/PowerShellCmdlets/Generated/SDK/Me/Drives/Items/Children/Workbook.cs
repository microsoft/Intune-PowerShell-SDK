...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook</para>
    ///     <para type="description">Retrieves the &quot;workbook&quot; object (which is of type &quot;microsoft.graph.workbook&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_Items_Children_Workbook", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbook")]
    [ResourceReference]
    public class Get_Me_Drives_Items_Children_Workbook : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/items/{itemId}/children/{childId}/workbook";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbook&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook</para>
    ///     <para type="description">Creates the &quot;workbook&quot; object (which is of type &quot;microsoft.graph.workbook&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_Items_Children_Workbook", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbook")]
    [ODataType("microsoft.graph.workbook")]
    [ResourceReference]
    public class New_Me_Drives_Items_Children_Workbook : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook</para>
    ///     <para type="description">Updates the &quot;workbook&quot; object (which is of type &quot;microsoft.graph.workbook&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_Items_Children_Workbook", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbook")]
    [ODataType("microsoft.graph.workbook")]
    public class Update_Me_Drives_Items_Children_Workbook : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook</para>
    ///     <para type="description">Removes the &quot;workbook&quot; object (which is of type &quot;microsoft.graph.workbook&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_Items_Children_Workbook", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbook")]
    public class Remove_Me_Drives_Items_Children_Workbook : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/createSession</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Children_Workbook_CreateSession", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbook")]
    public class Invoke_Me_Drives_Items_Children_Workbook_CreateSession : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/createSession";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/closeSession</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Children_Workbook_CloseSession", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbook")]
    public class Invoke_Me_Drives_Items_Children_Workbook_CloseSession : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/closeSession";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/refreshSession</para>
    ///     <para type="description">The action &quot;microsoft.graph.refreshSession&quot;, which exists on the type &quot;microsoft.graph.workbook&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Children_Workbook_RefreshSession", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbook")]
    public class Invoke_Me_Drives_Items_Children_Workbook_RefreshSession : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/refreshSession";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/processQuery</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Items_Children_Workbook_ProcessQuery", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbook")]
    public class Invoke_Me_Drives_Items_Children_Workbook_ProcessQuery : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/items/{itemId}/children/{childId}/workbook/processQuery";
        }
    }
}