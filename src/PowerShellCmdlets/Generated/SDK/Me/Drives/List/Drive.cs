...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/list/drive</para>
    ///     <para type="description">Retrieves the &quot;drive&quot; object (which is of type &quot;microsoft.graph.drive&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_List_Drive", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.drive")]
    [ResourceReference]
    public class Get_Me_Drives_List_Drive : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/list/drive";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.drive&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/drive</para>
    ///     <para type="description">Creates the &quot;drive&quot; object (which is of type &quot;microsoft.graph.drive&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_List_Drive", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.drive")]
    [ODataType("microsoft.graph.drive")]
    [ResourceReference]
    public class New_Me_Drives_List_Drive : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drives/{driveId}/list/drive</para>
    ///     <para type="description">Updates the &quot;drive&quot; object (which is of type &quot;microsoft.graph.drive&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_List_Drive", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.drive")]
    [ODataType("microsoft.graph.drive")]
    public class Update_Me_Drives_List_Drive : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drives/{driveId}/list/drive</para>
    ///     <para type="description">Removes the &quot;drive&quot; object (which is of type &quot;microsoft.graph.drive&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_List_Drive", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.drive")]
    public class Remove_Me_Drives_List_Drive : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/list/drive/recent</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Recent", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.drive")]
    public class Invoke_Me_Drives_List_Drive_Recent : FunctionReturningCollectionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/recent({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/list/drive/search</para>
    ///     <para type="description">The function &quot;microsoft.graph.search&quot;, which exists on the type &quot;microsoft.graph.drive&quot;.</para>
    ///     <para type="description">This function returns a collection of &quot;microsoft.graph.driveItem&quot; objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Search", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.drive")]
    public class Invoke_Me_Drives_List_Drive_Search : FunctionReturningCollectionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/search({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/list/drive/sharedWithMe</para>
    ///     <para type="description">The function &quot;microsoft.graph.sharedWithMe&quot;, which exists on the type &quot;microsoft.graph.drive&quot;.</para>
    ///     <para type="description">This function returns a collection of &quot;microsoft.graph.driveItem&quot; objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_SharedWithMe", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.drive")]
    public class Invoke_Me_Drives_List_Drive_SharedWithMe : FunctionReturningCollectionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/sharedWithMe({this.GetFunctionUrlSegment()})";
        }
    }
}