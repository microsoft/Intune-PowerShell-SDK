...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/list/items/{itemId}/driveItem/versions</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.driveItemVersion&quot; objects in the &quot;versions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_List_Items_DriveItem_Versions", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceIdPropertyName("versionId")]
    [ResourceReference]
    public class Get_Me_Drives_List_Items_DriveItem_Versions : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/list/items/{itemId}/driveItem/versions/{versionId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.driveItemVersion&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/items/{itemId}/driveItem/versions</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.driveItemVersion&quot; object to the &quot;versions&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_List_Items_DriveItem_Versions", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.driveItemVersion")]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceReference]
    public class New_Me_Drives_List_Items_DriveItem_Versions : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.listItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/items/{itemId}/driveItem/versions";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.driveItemVersion&quot;.</para>
    ///     <para type="description">PATCH ~/me/drives/{driveId}/list/items/{itemId}/driveItem/versions</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_List_Items_DriveItem_Versions", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.driveItemVersion")]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceIdPropertyName("versionId")]
    public class Update_Me_Drives_List_Items_DriveItem_Versions : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/items/{itemId}/driveItem/versions/{versionId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.driveItemVersion&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drives/{driveId}/list/items/{itemId}/driveItem/versions/versionId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.driveItemVersion&quot; object from the &quot;versions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_List_Items_DriveItem_Versions", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceIdPropertyName("versionId")]
    public class Remove_Me_Drives_List_Items_DriveItem_Versions : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/items/{itemId}/driveItem/versions/restoreVersion</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Items_DriveItem_Versions_RestoreVersion", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceIdPropertyName("versionId")]
    public class Invoke_Me_Drives_List_Items_DriveItem_Versions_RestoreVersion : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/items/{itemId}/driveItem/versions/{versionId}/restoreVersion";
        }
    }
}