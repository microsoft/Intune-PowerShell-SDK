...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/list/columns</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.columnDefinition&quot; objects in the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_List_Columns", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.columnDefinition")]
    [ResourceIdPropertyName("columnId")]
    [ResourceReference]
    public class Get_Me_Drives_List_Columns : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/list/columns/{columnId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.columnDefinition&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/columns</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.columnDefinition&quot; object to the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_List_Columns", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.columnDefinition")]
    [ODataType("microsoft.graph.columnDefinition")]
    [ResourceReference]
    public class New_Me_Drives_List_Columns : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/columns";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.columnDefinition&quot;.</para>
    ///     <para type="description">PATCH ~/me/drives/{driveId}/list/columns</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.columnDefinition&quot; object in the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_List_Columns", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.columnDefinition")]
    [ODataType("microsoft.graph.columnDefinition")]
    [ResourceIdPropertyName("columnId")]
    public class Update_Me_Drives_List_Columns : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.columnDefinition&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/columns/{columnId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.columnDefinition&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drives/{driveId}/list/columns/columnId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.columnDefinition&quot; object from the &quot;columns&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_List_Columns", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.columnDefinition")]
    [ResourceIdPropertyName("columnId")]
    public class Remove_Me_Drives_List_Columns : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.columnDefinition&quot; object in the &quot;columns&quot; collection.</para>
        /// </summary>
