...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/list/drive/items</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.driveItem&quot; objects in the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_List_Drive_Items", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    [ResourceReference]
    public class Get_Me_Drives_List_Drive_Items : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
        [Selectable]
        [Alias("id")]
        [ValidateNotNullOrEmpty]
        [Parameter(ParameterSetName = @"Get", ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.")]
        ...
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.driveItem&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/drive/items</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.driveItem&quot; object to the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_List_Drive_Items", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.driveItem")]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceReference]
    public class New_Me_Drives_List_Drive_Items : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.driveItem&quot;.</para>
    ///     <para type="description">PATCH ~/me/drives/{driveId}/list/drive/items</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_List_Drive_Items", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.driveItem")]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Update_Me_Drives_List_Drive_Items : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
        ...
        [Alias("id")]
        [ValidateNotNullOrEmpty]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.")]
        public System.String itemId { get; set; }
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.driveItem&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drives/{driveId}/list/drive/items/itemId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.driveItem&quot; object from the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_List_Drive_Items", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Remove_Me_Drives_List_Drive_Items : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
        ...
        [Alias("id")]
        [ValidateNotNullOrEmpty]
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.")]
        public System.String itemId { get; set; }
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/drive/items/copy</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Items_Copy", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Invoke_Me_Drives_List_Drive_Items_Copy : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId}/copy";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/drive/items/createLink</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Items_CreateLink", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Invoke_Me_Drives_List_Drive_Items_CreateLink : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId}/createLink";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/drive/items/createUploadSession</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Items_CreateUploadSession", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Invoke_Me_Drives_List_Drive_Items_CreateUploadSession : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId}/createUploadSession";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/drive/items/invite</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Items_Invite", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Invoke_Me_Drives_List_Drive_Items_Invite : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId}/invite";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/list/drive/items/delta</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Items_Delta", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Invoke_Me_Drives_List_Drive_Items_Delta : FunctionReturningCollectionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId}/delta({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drives/{driveId}/list/drive/items/search</para>
    ///     <para type="description">The function &quot;microsoft.graph.search&quot;, which exists on the type &quot;microsoft.graph.driveItem&quot;.</para>
    ///     <para type="description">This function returns a collection of &quot;microsoft.graph.driveItem&quot; objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_List_Drive_Items_Search", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.driveItem")]
    [ResourceIdPropertyName("itemId")]
    public class Invoke_Me_Drives_List_Drive_Items_Search : FunctionReturningCollectionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/drive/items/{itemId}/search({this.GetFunctionUrlSegment()})";
        }
    }
}