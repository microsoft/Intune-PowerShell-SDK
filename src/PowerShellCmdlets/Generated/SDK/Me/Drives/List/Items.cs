...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/list/items</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.listItem&quot; objects in the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_List_Items", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.listItem")]
    [ResourceIdPropertyName("itemId")]
    [ResourceReference]
    public class Get_Me_Drives_List_Items : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/list/items/{itemId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.listItem&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/list/items</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.listItem&quot; object to the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_List_Items", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.listItem")]
    [ODataType("microsoft.graph.listItem")]
    [ResourceReference]
    public class New_Me_Drives_List_Items : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.drive&quot; object in the &quot;drives&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/items";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.listItem&quot;.</para>
    ///     <para type="description">PATCH ~/me/drives/{driveId}/list/items</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.listItem&quot; object in the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_List_Items", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.listItem")]
    [ODataType("microsoft.graph.listItem")]
    [ResourceIdPropertyName("itemId")]
    public class Update_Me_Drives_List_Items : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.listItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/list/items/{itemId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.listItem&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drives/{driveId}/list/items/itemId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.listItem&quot; object from the &quot;items&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_List_Items", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.listItem")]
    [ResourceIdPropertyName("itemId")]
    public class Remove_Me_Drives_List_Items : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.listItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
