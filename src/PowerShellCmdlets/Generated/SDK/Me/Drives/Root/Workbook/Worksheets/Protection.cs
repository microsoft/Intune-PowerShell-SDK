...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection</para>
    ///     <para type="description">Retrieves the &quot;protection&quot; object (which is of type &quot;microsoft.graph.workbookWorksheetProtection&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_Root_Workbook_Worksheets_Protection", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheetProtection")]
    [ResourceReference]
    public class Get_Me_Drives_Root_Workbook_Worksheets_Protection : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookWorksheetProtection&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection</para>
    ///     <para type="description">Creates the &quot;protection&quot; object (which is of type &quot;microsoft.graph.workbookWorksheetProtection&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_Root_Workbook_Worksheets_Protection", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookWorksheetProtection")]
    [ODataType("microsoft.graph.workbookWorksheetProtection")]
    [ResourceReference]
    public class New_Me_Drives_Root_Workbook_Worksheets_Protection : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection</para>
    ///     <para type="description">Updates the &quot;protection&quot; object (which is of type &quot;microsoft.graph.workbookWorksheetProtection&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_Root_Workbook_Worksheets_Protection", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookWorksheetProtection")]
    [ODataType("microsoft.graph.workbookWorksheetProtection")]
    public class Update_Me_Drives_Root_Workbook_Worksheets_Protection : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection</para>
    ///     <para type="description">Removes the &quot;protection&quot; object (which is of type &quot;microsoft.graph.workbookWorksheetProtection&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_Root_Workbook_Worksheets_Protection", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookWorksheetProtection")]
    public class Remove_Me_Drives_Root_Workbook_Worksheets_Protection : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection/protect</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Root_Workbook_Worksheets_Protection_Protect", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookWorksheetProtection")]
    public class Invoke_Me_Drives_Root_Workbook_Worksheets_Protection_Protect : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection/protect";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection/unprotect</para>
    ...
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Root_Workbook_Worksheets_Protection_Unprotect", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookWorksheetProtection")]
    public class Invoke_Me_Drives_Root_Workbook_Worksheets_Protection_Unprotect : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/root/workbook/worksheets/{worksheetId}/protection/unprotect";
        }
    }
}