...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/root/workbook/tables/{tableId}/sort</para>
    ///     <para type="description">Retrieves the &quot;sort&quot; object (which is of type &quot;microsoft.graph.workbookTableSort&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_Root_Workbook_Tables_Sort", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableSort")]
    [ResourceReference]
    public class Get_Me_Drives_Root_Workbook_Tables_Sort : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/root/workbook/tables/{tableId}/sort";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookTableSort&quot; object.</para>
    ///     <para type="description">POST ~/me/drives/{driveId}/root/workbook/tables/{tableId}/sort</para>
    ///     <para type="description">Creates the &quot;sort&quot; object (which is of type &quot;microsoft.graph.workbookTableSort&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drives_Root_Workbook_Tables_Sort", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookTableSort")]
    [ODataType("microsoft.graph.workbookTableSort")]
    [ResourceReference]
    public class New_Me_Drives_Root_Workbook_Tables_Sort : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drives/{driveId}/root/workbook/tables/{tableId}/sort</para>
    ///     <para type="description">Updates the &quot;sort&quot; object (which is of type &quot;microsoft.graph.workbookTableSort&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drives_Root_Workbook_Tables_Sort", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookTableSort")]
    [ODataType("microsoft.graph.workbookTableSort")]
    public class Update_Me_Drives_Root_Workbook_Tables_Sort : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drives/{driveId}/root/workbook/tables/{tableId}/sort</para>
    ///     <para type="description">Removes the &quot;sort&quot; object (which is of type &quot;microsoft.graph.workbookTableSort&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_Root_Workbook_Tables_Sort", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableSort")]
    public class Remove_Me_Drives_Root_Workbook_Tables_Sort : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/root/workbook/tables/{tableId}/sort/apply</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Root_Workbook_Tables_Sort_Apply", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableSort")]
    public class Invoke_Me_Drives_Root_Workbook_Tables_Sort_Apply : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/root/workbook/tables/{tableId}/sort/apply";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/root/workbook/tables/{tableId}/sort/clear</para>
    ///     <para type="description">The action &quot;microsoft.graph.clear&quot;, which exists on the type &quot;microsoft.graph.workbookTableSort&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Root_Workbook_Tables_Sort_Clear", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableSort")]
    public class Invoke_Me_Drives_Root_Workbook_Tables_Sort_Clear : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/root/workbook/tables/{tableId}/sort/clear";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drives/{driveId}/root/workbook/tables/{tableId}/sort/reapply</para>
    ///     <para type="description">The action &quot;microsoft.graph.reapply&quot;, which exists on the type &quot;microsoft.graph.workbookTableSort&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drives_Root_Workbook_Tables_Sort_Reapply", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableSort")]
    public class Invoke_Me_Drives_Root_Workbook_Tables_Sort_Reapply : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drives/{driveId}/root/workbook/tables/{tableId}/sort/reapply";
        }
    }
}