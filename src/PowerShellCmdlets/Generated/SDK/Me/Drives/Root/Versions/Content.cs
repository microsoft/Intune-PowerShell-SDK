...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drives/{driveId}/root/versions/{versionId}/content</para>
    ///     <para type="description">Retrieves the data stream from the &quot;content&quot; object.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drives_Root_Versions_Content")]
    [ODataType("Edm.Stream")]
    public class Get_Me_Drives_Root_Versions_Content : GetStreamCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drives/{driveId}/root/versions/{versionId}/content";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Sets the data for the &quot;content&quot; property on a &quot;microsoft.graph.driveItemVersion&quot; object.</para>
    ///     <para type="description">PUT ~/me/drives/{driveId}/root/versions/{versionId}/content</para>
    ///     <para type="description">Sets the data for the &quot;content&quot; property on a &quot;microsoft.graph.driveItemVersion&quot; object.</para>
    /// </summary>
    [Cmdlet("Set", "Me_Drives_Root_Versions_Content", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("Edm.Stream")]
    public class Set_Me_Drives_Root_Versions_Content : UpdateStreamCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drives/{driveId}/root/versions/{versionId}/content/$ref</para>
    ///     <para type="description">Removes a reference from a &quot;content&quot; resource (which is of type &quot;Edm.Stream&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drives_Root_Versions_ContentData", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("Edm.Stream")]
    public class Remove_Me_Drives_Root_Versions_ContentData : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
