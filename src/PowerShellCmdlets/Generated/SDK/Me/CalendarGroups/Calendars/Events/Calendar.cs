...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/calendarGroups/{calendarGroupId}/calendars/{calendarId}/events/{eventId}/calendar</para>
    ///     <para type="description">Retrieves the &quot;calendar&quot; object (which is of type &quot;microsoft.graph.calendar&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_CalendarGroups_Calendars_Events_Calendar", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.calendar")]
    [ResourceReference]
    public class Get_Me_CalendarGroups_Calendars_Events_Calendar : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/calendarGroups/{calendarGroupId}/calendars/{calendarId}/events/{eventId}/calendar";
        }
    }
}