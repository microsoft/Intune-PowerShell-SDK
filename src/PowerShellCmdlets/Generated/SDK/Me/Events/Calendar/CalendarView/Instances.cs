...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.event&quot; objects in the &quot;instances&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Events_Calendar_CalendarView_Instances", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("instanceId")]
    [ResourceReference]
    public class Get_Me_Events_Calendar_CalendarView_Instances : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/{instanceId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/accept</para>
    ///     <para type="description">The action &quot;microsoft.graph.accept&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Calendar_CalendarView_Instances_Accept", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("instanceId")]
    public class Invoke_Me_Events_Calendar_CalendarView_Instances_Accept : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/{instanceId}/accept";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/decline</para>
    ///     <para type="description">The action &quot;microsoft.graph.decline&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Calendar_CalendarView_Instances_Decline", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("instanceId")]
    public class Invoke_Me_Events_Calendar_CalendarView_Instances_Decline : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/{instanceId}/decline";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/tentativelyAccept</para>
    ///     <para type="description">The action &quot;microsoft.graph.tentativelyAccept&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Calendar_CalendarView_Instances_TentativelyAccept", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("instanceId")]
    public class Invoke_Me_Events_Calendar_CalendarView_Instances_TentativelyAccept : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/{instanceId}/tentativelyAccept";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/snoozeReminder</para>
    ///     <para type="description">The action &quot;microsoft.graph.snoozeReminder&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Calendar_CalendarView_Instances_SnoozeReminder", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("instanceId")]
    public class Invoke_Me_Events_Calendar_CalendarView_Instances_SnoozeReminder : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/{instanceId}/snoozeReminder";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/dismissReminder</para>
    ///     <para type="description">The action &quot;microsoft.graph.dismissReminder&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Calendar_CalendarView_Instances_DismissReminder", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("instanceId")]
    public class Invoke_Me_Events_Calendar_CalendarView_Instances_DismissReminder : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.event&quot; object in the &quot;instances&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/{instanceId}/dismissReminder";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/delta</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Calendar_CalendarView_Instances_Delta", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.event")]
    public class Invoke_Me_Events_Calendar_CalendarView_Instances_Delta : FunctionReturningCollectionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.event&quot; object in the &quot;calendarView&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/calendar/calendarView/{calendarViewId}/instances/delta({this.GetFunctionUrlSegment()})";
        }
    }
}