...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/events/{eventId}/instances/{instanceId}/calendar</para>
    ///     <para type="description">Retrieves the &quot;calendar&quot; object (which is of type &quot;microsoft.graph.calendar&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Events_Instances_Calendar", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.calendar")]
    [ResourceReference]
    public class Get_Me_Events_Instances_Calendar : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/events/{eventId}/instances/{instanceId}/calendar";
        }
    }
}