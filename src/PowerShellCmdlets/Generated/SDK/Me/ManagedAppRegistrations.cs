...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    public class New_Me_ManagedAppRegistrationsReferences : PostReferenceToCollectionCmdlet
    {
        ...
        [ValidateNotNullOrEmpty]
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The URL which should be used to access a &quot;microsoft.graph.managedAppRegistration&quot; object.")]
        public System.String managedAppRegistrationReferenceUrl { get; set; }

        internal override System.String GetResourcePath()
        {
            return $"me/managedAppRegistrations/$ref";
        }
