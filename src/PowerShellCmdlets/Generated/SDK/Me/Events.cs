...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/events</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.event&quot; objects in the &quot;events&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Events", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    [ResourceReference]
    public class Get_Me_Events : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/events/{eventId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.event&quot; object.</para>
    ///     <para type="description">POST ~/me/events</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.event&quot; object to the &quot;events&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Events", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.event")]
    [ODataType("microsoft.graph.event")]
    [ResourceReference]
    public class New_Me_Events : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">The &quot;originalStartTimeZone&quot; property, of type &quot;Edm.String&quot;.</para>
        ///     <para type="description">This property is on the &quot;microsoft.graph.event&quot; type.</para>
    ...
    ///     <para type="description">PATCH ~/me/events</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.event&quot; object in the &quot;events&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Events", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.event")]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    public class Update_Me_Events : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.event&quot; object in the &quot;events&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.event&quot; object.</para>
    ///     <para type="description">DELETE ~/me/events/eventId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.event&quot; object from the &quot;events&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Events", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    public class Remove_Me_Events : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.event&quot; object in the &quot;events&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/events/accept</para>
    ///     <para type="description">The action &quot;microsoft.graph.accept&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Accept", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    public class Invoke_Me_Events_Accept : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/accept";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/decline</para>
    ///     <para type="description">The action &quot;microsoft.graph.decline&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Decline", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    public class Invoke_Me_Events_Decline : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/decline";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/tentativelyAccept</para>
    ///     <para type="description">The action &quot;microsoft.graph.tentativelyAccept&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_TentativelyAccept", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    public class Invoke_Me_Events_TentativelyAccept : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/tentativelyAccept";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/snoozeReminder</para>
    ///     <para type="description">The action &quot;microsoft.graph.snoozeReminder&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_SnoozeReminder", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    public class Invoke_Me_Events_SnoozeReminder : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/snoozeReminder";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/events/dismissReminder</para>
    ///     <para type="description">The action &quot;microsoft.graph.dismissReminder&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_DismissReminder", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("eventId")]
    public class Invoke_Me_Events_DismissReminder : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.event&quot; object in the &quot;events&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/events/{eventId}/dismissReminder";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/events/delta</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Events_Delta", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.event")]
    public class Invoke_Me_Events_Delta : FunctionReturningCollectionCmdlet
    {
        internal override System.String GetResourcePath()
        {
            return $"me/events/delta({this.GetFunctionUrlSegment()})";
        }
    }
}