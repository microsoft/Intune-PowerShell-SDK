...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/contacts/{contactId}/photo</para>
    ///     <para type="description">Retrieves the &quot;photo&quot; object (which is of type &quot;microsoft.graph.profilePhoto&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Contacts_Photo", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.profilePhoto")]
    [ResourceReference]
    public class Get_Me_Contacts_Photo : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/contacts/{contactId}/photo";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.profilePhoto&quot;.</para>
    ///     <para type="description">PATCH ~/me/contacts/{contactId}/photo</para>
    ///     <para type="description">Updates the &quot;photo&quot; object (which is of type &quot;microsoft.graph.profilePhoto&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Contacts_Photo", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.profilePhoto")]
    [ODataType("microsoft.graph.profilePhoto")]
    public class Update_Me_Contacts_Photo : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.contact&quot; object in the &quot;contacts&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">GET ~/me/contacts/{contactId}/photo/$value</para>
    ///     <para type="description">Retrieves the data stream from the &quot;photo&quot; object.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Contacts_PhotoData")]
    [ODataType("microsoft.graph.profilePhoto")]
    public class Get_Me_Contacts_PhotoData : GetStreamCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.contact&quot; object in the &quot;contacts&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/contacts/{contactId}/photo/$value";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Sets the data for the &quot;photo&quot; property.</para>
    ///     <para type="description">PUT ~/me/contacts/{contactId}/photo/$value</para>
    ///     <para type="description">Sets the data for the &quot;photo&quot; property.</para>
    /// </summary>
    [Cmdlet("New", "Me_Contacts_PhotoData", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("microsoft.graph.profilePhoto")]
    public class New_Me_Contacts_PhotoData : UpdateStreamCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.contact&quot; object in the &quot;contacts&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">Sets the data for the &quot;photo&quot; property.</para>
    /// </summary>
    [Cmdlet("Set", "Me_Contacts_PhotoData", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("microsoft.graph.profilePhoto")]
    public class Set_Me_Contacts_PhotoData : UpdateStreamCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.contact&quot; object in the &quot;contacts&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/contacts/{contactId}/photo/$ref</para>
    ///     <para type="description">Removes a reference from a &quot;photo&quot; resource (which is of type &quot;microsoft.graph.profilePhoto&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Contacts_PhotoData", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.profilePhoto")]
    public class Remove_Me_Contacts_PhotoData : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.contact&quot; object in the &quot;contacts&quot; collection.</para>
        /// </summary>
