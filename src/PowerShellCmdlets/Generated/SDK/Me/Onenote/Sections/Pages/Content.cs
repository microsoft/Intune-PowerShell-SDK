...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/onenote/sections/{sectionId}/pages/{pageId}/content</para>
    ///     <para type="description">Retrieves the data stream from the &quot;content&quot; object.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Onenote_Sections_Pages_Content")]
    [ODataType("Edm.Stream")]
    public class Get_Me_Onenote_Sections_Pages_Content : GetStreamCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/onenote/sections/{sectionId}/pages/{pageId}/content";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Sets the data for the &quot;content&quot; property on a &quot;microsoft.graph.onenotePage&quot; object.</para>
    ///     <para type="description">PUT ~/me/onenote/sections/{sectionId}/pages/{pageId}/content</para>
    ///     <para type="description">Sets the data for the &quot;content&quot; property on a &quot;microsoft.graph.onenotePage&quot; object.</para>
    /// </summary>
    [Cmdlet("Set", "Me_Onenote_Sections_Pages_Content", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("Edm.Stream")]
    public class Set_Me_Onenote_Sections_Pages_Content : UpdateStreamCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.onenotePage&quot; object in the &quot;pages&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/onenote/sections/{sectionId}/pages/{pageId}/content/$ref</para>
    ///     <para type="description">Removes a reference from a &quot;content&quot; resource (which is of type &quot;Edm.Stream&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Onenote_Sections_Pages_ContentData", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("Edm.Stream")]
    public class Remove_Me_Onenote_Sections_Pages_ContentData : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.onenotePage&quot; object in the &quot;pages&quot; collection.</para>
        /// </summary>
