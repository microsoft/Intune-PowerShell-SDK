...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/application</para>
    ///     <para type="description">Retrieves the &quot;application&quot; object (which is of type &quot;microsoft.graph.workbookApplication&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Special_Workbook_Application", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookApplication")]
    [ResourceReference]
    public class Get_Me_Drive_Special_Workbook_Application : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/special/{specialId}/workbook/application";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookApplication&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/application</para>
    ///     <para type="description">Creates the &quot;application&quot; object (which is of type &quot;microsoft.graph.workbookApplication&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Special_Workbook_Application", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookApplication")]
    [ODataType("microsoft.graph.workbookApplication")]
    [ResourceReference]
    public class New_Me_Drive_Special_Workbook_Application : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;special&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drive/special/{specialId}/workbook/application</para>
    ///     <para type="description">Updates the &quot;application&quot; object (which is of type &quot;microsoft.graph.workbookApplication&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Special_Workbook_Application", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookApplication")]
    [ODataType("microsoft.graph.workbookApplication")]
    public class Update_Me_Drive_Special_Workbook_Application : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;special&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drive/special/{specialId}/workbook/application</para>
    ///     <para type="description">Removes the &quot;application&quot; object (which is of type &quot;microsoft.graph.workbookApplication&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Special_Workbook_Application", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookApplication")]
    public class Remove_Me_Drive_Special_Workbook_Application : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;special&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/application/calculate</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Application_Calculate", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookApplication")]
    public class Invoke_Me_Drive_Special_Workbook_Application_Calculate : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/application/calculate";
        }
    }
}