...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.workbookPivotTable&quot; objects in the &quot;pivotTables&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Special_Workbook_Worksheets_PivotTables", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.workbookPivotTable")]
    [ResourceIdPropertyName("pivotTableId")]
    [ResourceReference]
    public class Get_Me_Drive_Special_Workbook_Worksheets_PivotTables : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables/{pivotTableId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookPivotTable&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.workbookPivotTable&quot; object to the &quot;pivotTables&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Special_Workbook_Worksheets_PivotTables", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookPivotTable")]
    [ODataType("microsoft.graph.workbookPivotTable")]
    [ResourceReference]
    public class New_Me_Drive_Special_Workbook_Worksheets_PivotTables : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.workbookPivotTable&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.workbookPivotTable&quot; object in the &quot;pivotTables&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Special_Workbook_Worksheets_PivotTables", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookPivotTable")]
    [ODataType("microsoft.graph.workbookPivotTable")]
    [ResourceIdPropertyName("pivotTableId")]
    public class Update_Me_Drive_Special_Workbook_Worksheets_PivotTables : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookPivotTable&quot; object in the &quot;pivotTables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables/{pivotTableId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.workbookPivotTable&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables/pivotTableId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.workbookPivotTable&quot; object from the &quot;pivotTables&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Special_Workbook_Worksheets_PivotTables", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookPivotTable")]
    [ResourceIdPropertyName("pivotTableId")]
    public class Remove_Me_Drive_Special_Workbook_Worksheets_PivotTables : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookPivotTable&quot; object in the &quot;pivotTables&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables/refresh</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_PivotTables_Refresh", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookPivotTable")]
    [ResourceIdPropertyName("pivotTableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_PivotTables_Refresh : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookPivotTable&quot; object in the &quot;pivotTables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables/{pivotTableId}/refresh";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables/refreshAll</para>
    ...
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_PivotTables_RefreshAll", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookPivotTable")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_PivotTables_RefreshAll : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/pivotTables/refreshAll";
        }
    }
}