...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.workbookTableRow&quot; objects in the &quot;rows&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Special_Workbook_Tables_Rows", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.workbookTableRow")]
    [ResourceIdPropertyName("rowId")]
    [ResourceReference]
    public class Get_Me_Drive_Special_Workbook_Tables_Rows : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/special/{specialId}/workbook/tables/{tableId}/rows/{rowId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookTableRow&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.workbookTableRow&quot; object to the &quot;rows&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Special_Workbook_Tables_Rows", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookTableRow")]
    [ODataType("microsoft.graph.workbookTableRow")]
    [ResourceReference]
    public class New_Me_Drive_Special_Workbook_Tables_Rows : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/tables/{tableId}/rows";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.workbookTableRow&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.workbookTableRow&quot; object in the &quot;rows&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Special_Workbook_Tables_Rows", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookTableRow")]
    [ODataType("microsoft.graph.workbookTableRow")]
    [ResourceIdPropertyName("rowId")]
    public class Update_Me_Drive_Special_Workbook_Tables_Rows : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableRow&quot; object in the &quot;rows&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/tables/{tableId}/rows/{rowId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.workbookTableRow&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows/rowId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.workbookTableRow&quot; object from the &quot;rows&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Special_Workbook_Tables_Rows", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableRow")]
    [ResourceIdPropertyName("rowId")]
    public class Remove_Me_Drive_Special_Workbook_Tables_Rows : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableRow&quot; object in the &quot;rows&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows/add</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Tables_Rows_Add", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTableRow")]
    public class Invoke_Me_Drive_Special_Workbook_Tables_Rows_Add : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/tables/{tableId}/rows/add";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows/range</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Tables_Rows_Range", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableRow")]
    [ResourceIdPropertyName("rowId")]
    public class Invoke_Me_Drive_Special_Workbook_Tables_Rows_Range : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTableRow&quot; object in the &quot;rows&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/tables/{tableId}/rows/{rowId}/range({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows/itemAt</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Tables_Rows_ItemAt", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableRow")]
    public class Invoke_Me_Drive_Special_Workbook_Tables_Rows_ItemAt : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/tables/{tableId}/rows/itemAt({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/tables/{tableId}/rows/count</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Tables_Rows_Count", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTableRow")]
    public class Invoke_Me_Drive_Special_Workbook_Tables_Rows_Count : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/tables/{tableId}/rows/count({this.GetFunctionUrlSegment()})";
        }
    }
}