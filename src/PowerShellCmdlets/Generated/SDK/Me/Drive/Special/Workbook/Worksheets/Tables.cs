...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.workbookTable&quot; objects in the &quot;tables&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Special_Workbook_Worksheets_Tables", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    [ResourceReference]
    public class Get_Me_Drive_Special_Workbook_Worksheets_Tables : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookTable&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.workbookTable&quot; object to the &quot;tables&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Special_Workbook_Worksheets_Tables", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookTable")]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceReference]
    public class New_Me_Drive_Special_Workbook_Worksheets_Tables : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.workbookTable&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Special_Workbook_Worksheets_Tables", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookTable")]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Update_Me_Drive_Special_Workbook_Worksheets_Tables : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.workbookTable&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/tableId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.workbookTable&quot; object from the &quot;tables&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Special_Workbook_Worksheets_Tables", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Remove_Me_Drive_Special_Workbook_Worksheets_Tables : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/clearFilters</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_ClearFilters", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_ClearFilters : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}/clearFilters";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/convertToRange</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_ConvertToRange", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_ConvertToRange : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}/convertToRange";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/reapplyFilters</para>
    ...
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_ReapplyFilters", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_ReapplyFilters : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}/reapplyFilters";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/add</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_Add", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookTable")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_Add : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/add";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/dataBodyRange</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_DataBodyRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_DataBodyRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}/dataBodyRange({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/headerRowRange</para>
    ...
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_HeaderRowRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_HeaderRowRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}/headerRowRange({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/range</para>
    ///     <para type="description">The function &quot;microsoft.graph.range&quot;, which exists on the type &quot;microsoft.graph.workbookTable&quot;.</para>
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_Range", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_Range : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}/range({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/totalRowRange</para>
    ...
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_TotalRowRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTable")]
    [ResourceIdPropertyName("tableId")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_TotalRowRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/{tableId}/totalRowRange({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/itemAt</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_ItemAt", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTable")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_ItemAt : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/itemAt({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/count</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Workbook_Worksheets_Tables_Count", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookTable")]
    public class Invoke_Me_Drive_Special_Workbook_Worksheets_Tables_Count : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/workbook/worksheets/{worksheetId}/tables/count({this.GetFunctionUrlSegment()})";
        }
    }
}