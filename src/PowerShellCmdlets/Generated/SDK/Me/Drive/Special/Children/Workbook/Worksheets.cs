...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.workbookWorksheet&quot; objects in the &quot;worksheets&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Special_Children_Workbook_Worksheets", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceIdPropertyName("worksheetId")]
    [ResourceReference]
    public class Get_Me_Drive_Special_Children_Workbook_Worksheets : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/special/{specialId}/children/{childId}/workbook/worksheets/{worksheetId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookWorksheet&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.workbookWorksheet&quot; object to the &quot;worksheets&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Special_Children_Workbook_Worksheets", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookWorksheet")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceReference]
    public class New_Me_Drive_Special_Children_Workbook_Worksheets : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/children/{childId}/workbook/worksheets";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.workbookWorksheet&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Special_Children_Workbook_Worksheets", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookWorksheet")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceIdPropertyName("worksheetId")]
    public class Update_Me_Drive_Special_Children_Workbook_Worksheets : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/children/{childId}/workbook/worksheets/{worksheetId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.workbookWorksheet&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets/worksheetId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.workbookWorksheet&quot; object from the &quot;worksheets&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Special_Children_Workbook_Worksheets", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceIdPropertyName("worksheetId")]
    public class Remove_Me_Drive_Special_Children_Workbook_Worksheets : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets/add</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Children_Workbook_Worksheets_Add", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookWorksheet")]
    public class Invoke_Me_Drive_Special_Children_Workbook_Worksheets_Add : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/children/{childId}/workbook/worksheets/add";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets/cell</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Children_Workbook_Worksheets_Cell", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceIdPropertyName("worksheetId")]
    public class Invoke_Me_Drive_Special_Children_Workbook_Worksheets_Cell : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/children/{childId}/workbook/worksheets/{worksheetId}/cell({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets/range</para>
    ///     <para type="description">The function &quot;microsoft.graph.range&quot;, which exists on the type &quot;microsoft.graph.workbookWorksheet&quot;.</para>
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Children_Workbook_Worksheets_Range", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceIdPropertyName("worksheetId")]
    public class Invoke_Me_Drive_Special_Children_Workbook_Worksheets_Range : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/children/{childId}/workbook/worksheets/{worksheetId}/range({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/special/{specialId}/children/{childId}/workbook/worksheets/usedRange</para>
    ...
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Special_Children_Workbook_Worksheets_UsedRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceIdPropertyName("worksheetId")]
    public class Invoke_Me_Drive_Special_Children_Workbook_Worksheets_UsedRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookWorksheet&quot; object in the &quot;worksheets&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/special/{specialId}/children/{childId}/workbook/worksheets/{worksheetId}/usedRange({this.GetFunctionUrlSegment()})";
        }
    }
}