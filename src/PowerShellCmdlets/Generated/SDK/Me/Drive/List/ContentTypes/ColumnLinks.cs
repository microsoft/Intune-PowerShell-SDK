...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/list/contentTypes/{contentTypeId}/columnLinks</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.columnLink&quot; objects in the &quot;columnLinks&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_List_ContentTypes_ColumnLinks", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.columnLink")]
    [ResourceIdPropertyName("columnLinkId")]
    [ResourceReference]
    public class Get_Me_Drive_List_ContentTypes_ColumnLinks : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/list/contentTypes/{contentTypeId}/columnLinks/{columnLinkId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.columnLink&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/list/contentTypes/{contentTypeId}/columnLinks</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.columnLink&quot; object to the &quot;columnLinks&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_List_ContentTypes_ColumnLinks", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.columnLink")]
    [ODataType("microsoft.graph.columnLink")]
    [ResourceReference]
    public class New_Me_Drive_List_ContentTypes_ColumnLinks : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.contentType&quot; object in the &quot;contentTypes&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/list/contentTypes/{contentTypeId}/columnLinks";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.columnLink&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/list/contentTypes/{contentTypeId}/columnLinks</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.columnLink&quot; object in the &quot;columnLinks&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_List_ContentTypes_ColumnLinks", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.columnLink")]
    [ODataType("microsoft.graph.columnLink")]
    [ResourceIdPropertyName("columnLinkId")]
    public class Update_Me_Drive_List_ContentTypes_ColumnLinks : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.columnLink&quot; object in the &quot;columnLinks&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/list/contentTypes/{contentTypeId}/columnLinks/{columnLinkId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.columnLink&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/list/contentTypes/{contentTypeId}/columnLinks/columnLinkId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.columnLink&quot; object from the &quot;columnLinks&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_List_ContentTypes_ColumnLinks", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.columnLink")]
    [ResourceIdPropertyName("columnLinkId")]
    public class Remove_Me_Drive_List_ContentTypes_ColumnLinks : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.columnLink&quot; object in the &quot;columnLinks&quot; collection.</para>
        /// </summary>
