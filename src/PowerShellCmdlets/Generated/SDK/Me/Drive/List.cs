...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/list</para>
    ///     <para type="description">Retrieves the &quot;list&quot; object (which is of type &quot;microsoft.graph.list&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_List", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.list")]
    [ResourceReference]
    public class Get_Me_Drive_List : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/list";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.list&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/list</para>
    ///     <para type="description">Creates the &quot;list&quot; object (which is of type &quot;microsoft.graph.list&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_List", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.list")]
    [ODataType("microsoft.graph.list")]
    [ResourceReference]
    public class New_Me_Drive_List : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">The &quot;displayName&quot; property, of type &quot;Edm.String&quot;.</para>
        ///     <para type="description">This property is on the &quot;microsoft.graph.list&quot; type.</para>
    ...
    ///     <para type="description">PATCH ~/me/drive/list</para>
    ///     <para type="description">Updates the &quot;list&quot; object (which is of type &quot;microsoft.graph.list&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_List", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.list")]
    [ODataType("microsoft.graph.list")]
    public class Update_Me_Drive_List : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The &quot;displayName&quot; property, of type &quot;Edm.String&quot;.</para>
        ///     <para type="description">This property is on the &quot;microsoft.graph.list&quot; type.</para>
    ...
    ///     <para type="description">DELETE ~/me/drive/list</para>
    ///     <para type="description">Removes the &quot;list&quot; object (which is of type &quot;microsoft.graph.list&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_List", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.list")]
    public class Remove_Me_Drive_List : DeleteCmdlet
    {
        internal override System.String GetResourcePath()
        {
            return $"me/drive/list";
