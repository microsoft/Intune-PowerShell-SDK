...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    public class Get_Me_Drive_Root_Versions : GetOrSearchCmdlet
    {
        ...
        {
            return $"me/drive/root/versions/{versionId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.driveItemVersion&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/root/versions</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.driveItemVersion&quot; object to the &quot;versions&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Root_Versions", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.driveItemVersion")]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceReference]
    public class New_Me_Drive_Root_Versions : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">The &quot;content&quot; property, of type &quot;Edm.Stream&quot;.</para>
        ///     <para type="description">This property is on the &quot;microsoft.graph.driveItemVersion&quot; type.</para>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/versions";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.driveItemVersion&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/root/versions</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Root_Versions", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.driveItemVersion")]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceIdPropertyName("versionId")]
    public class Update_Me_Drive_Root_Versions : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/versions/{versionId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.driveItemVersion&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/root/versions/versionId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.driveItemVersion&quot; object from the &quot;versions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Root_Versions", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceIdPropertyName("versionId")]
    public class Remove_Me_Drive_Root_Versions : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/root/versions/restoreVersion</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Root_Versions_RestoreVersion", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.driveItemVersion")]
    [ResourceIdPropertyName("versionId")]
    public class Invoke_Me_Drive_Root_Versions_RestoreVersion : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.driveItemVersion&quot; object in the &quot;versions&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/versions/{versionId}/restoreVersion";
        }
    }
}