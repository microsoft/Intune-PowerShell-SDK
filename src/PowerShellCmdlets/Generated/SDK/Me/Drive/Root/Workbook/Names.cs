...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/root/workbook/names</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.workbookNamedItem&quot; objects in the &quot;names&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Root_Workbook_Names", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.workbookNamedItem")]
    [ResourceIdPropertyName("nameId")]
    [ResourceReference]
    public class Get_Me_Drive_Root_Workbook_Names : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/root/workbook/names/{nameId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookNamedItem&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/root/workbook/names</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.workbookNamedItem&quot; object to the &quot;names&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Root_Workbook_Names", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookNamedItem")]
    [ODataType("microsoft.graph.workbookNamedItem")]
    [ResourceReference]
    public class New_Me_Drive_Root_Workbook_Names : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">The &quot;comment&quot; property, of type &quot;Edm.String&quot;.</para>
        ///     <para type="description">This property is on the &quot;microsoft.graph.workbookNamedItem&quot; type.</para>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/workbook/names";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.workbookNamedItem&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/root/workbook/names</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.workbookNamedItem&quot; object in the &quot;names&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Root_Workbook_Names", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookNamedItem")]
    [ODataType("microsoft.graph.workbookNamedItem")]
    [ResourceIdPropertyName("nameId")]
    public class Update_Me_Drive_Root_Workbook_Names : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookNamedItem&quot; object in the &quot;names&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/workbook/names/{nameId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.workbookNamedItem&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/root/workbook/names/nameId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.workbookNamedItem&quot; object from the &quot;names&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Root_Workbook_Names", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookNamedItem")]
    [ResourceIdPropertyName("nameId")]
    public class Remove_Me_Drive_Root_Workbook_Names : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookNamedItem&quot; object in the &quot;names&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/root/workbook/names/add</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Root_Workbook_Names_Add", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookNamedItem")]
    public class Invoke_Me_Drive_Root_Workbook_Names_Add : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/workbook/names/add";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/drive/root/workbook/names/addFormulaLocal</para>
    ...
    ///     <para type="description">This action returns a &quot;microsoft.graph.workbookNamedItem&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Root_Workbook_Names_AddFormulaLocal", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookNamedItem")]
    public class Invoke_Me_Drive_Root_Workbook_Names_AddFormulaLocal : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/workbook/names/addFormulaLocal";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/root/workbook/names/range</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Root_Workbook_Names_Range", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookNamedItem")]
    [ResourceIdPropertyName("nameId")]
    public class Invoke_Me_Drive_Root_Workbook_Names_Range : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.workbookNamedItem&quot; object in the &quot;names&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/root/workbook/names/{nameId}/range({this.GetFunctionUrlSegment()})";
        }
    }
}