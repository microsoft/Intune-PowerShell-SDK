...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/items/{itemId}/listItem/driveItem/thumbnails</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.thumbnailSet&quot; objects in the &quot;thumbnails&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Items_ListItem_DriveItem_Thumbnails", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.thumbnailSet")]
    [ResourceIdPropertyName("thumbnailId")]
    [ResourceReference]
    public class Get_Me_Drive_Items_ListItem_DriveItem_Thumbnails : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/items/{itemId}/listItem/driveItem/thumbnails/{thumbnailId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.thumbnailSet&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/items/{itemId}/listItem/driveItem/thumbnails</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.thumbnailSet&quot; object to the &quot;thumbnails&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Items_ListItem_DriveItem_Thumbnails", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.thumbnailSet")]
    [ODataType("microsoft.graph.thumbnailSet")]
    [ResourceReference]
    public class New_Me_Drive_Items_ListItem_DriveItem_Thumbnails : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;items&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/listItem/driveItem/thumbnails";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.thumbnailSet&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/items/{itemId}/listItem/driveItem/thumbnails</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.thumbnailSet&quot; object in the &quot;thumbnails&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Items_ListItem_DriveItem_Thumbnails", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.thumbnailSet")]
    [ODataType("microsoft.graph.thumbnailSet")]
    [ResourceIdPropertyName("thumbnailId")]
    public class Update_Me_Drive_Items_ListItem_DriveItem_Thumbnails : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.thumbnailSet&quot; object in the &quot;thumbnails&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/listItem/driveItem/thumbnails/{thumbnailId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.thumbnailSet&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/items/{itemId}/listItem/driveItem/thumbnails/thumbnailId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.thumbnailSet&quot; object from the &quot;thumbnails&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Items_ListItem_DriveItem_Thumbnails", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.thumbnailSet")]
    [ResourceIdPropertyName("thumbnailId")]
    public class Remove_Me_Drive_Items_ListItem_DriveItem_Thumbnails : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.thumbnailSet&quot; object in the &quot;thumbnails&quot; collection.</para>
        /// </summary>
