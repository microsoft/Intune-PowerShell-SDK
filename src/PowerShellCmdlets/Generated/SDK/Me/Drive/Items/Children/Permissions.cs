...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/items/{itemId}/children/{childId}/permissions</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.permission&quot; objects in the &quot;permissions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Items_Children_Permissions", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.permission")]
    [ResourceIdPropertyName("permissionId")]
    [ResourceReference]
    public class Get_Me_Drive_Items_Children_Permissions : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/items/{itemId}/children/{childId}/permissions/{permissionId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.permission&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/items/{itemId}/children/{childId}/permissions</para>
    ///     <para type="description">Adds a &quot;microsoft.graph.permission&quot; object to the &quot;permissions&quot; collection.</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Items_Children_Permissions", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.permission")]
    [ODataType("microsoft.graph.permission")]
    [ResourceReference]
    public class New_Me_Drive_Items_Children_Permissions : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.driveItem&quot; object in the &quot;children&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/children/{childId}/permissions";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.permission&quot;.</para>
    ///     <para type="description">PATCH ~/me/drive/items/{itemId}/children/{childId}/permissions</para>
    ///     <para type="description">Updates a &quot;microsoft.graph.permission&quot; object in the &quot;permissions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Items_Children_Permissions", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.permission")]
    [ODataType("microsoft.graph.permission")]
    [ResourceIdPropertyName("permissionId")]
    public class Update_Me_Drive_Items_Children_Permissions : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.permission&quot; object in the &quot;permissions&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/children/{childId}/permissions/{permissionId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.permission&quot; object.</para>
    ///     <para type="description">DELETE ~/me/drive/items/{itemId}/children/{childId}/permissions/permissionId</para>
    ///     <para type="description">Removes a &quot;microsoft.graph.permission&quot; object from the &quot;permissions&quot; collection.</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Items_Children_Permissions", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.permission")]
    [ResourceIdPropertyName("permissionId")]
    public class Remove_Me_Drive_Items_Children_Permissions : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.permission&quot; object in the &quot;permissions&quot; collection.</para>
        /// </summary>
