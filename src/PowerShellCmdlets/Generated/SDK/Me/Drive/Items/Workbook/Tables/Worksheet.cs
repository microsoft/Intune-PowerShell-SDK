...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet</para>
    ///     <para type="description">Retrieves the &quot;worksheet&quot; object (which is of type &quot;microsoft.graph.workbookWorksheet&quot;).</para>
    /// </summary>
    [Cmdlet("Get", "Me_Drive_Items_Workbook_Tables_Worksheet", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceReference]
    public class Get_Me_Drive_Items_Workbook_Tables_Worksheet : GetCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.workbookWorksheet&quot; object.</para>
    ///     <para type="description">POST ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet</para>
    ///     <para type="description">Creates the &quot;worksheet&quot; object (which is of type &quot;microsoft.graph.workbookWorksheet&quot;).</para>
    /// </summary>
    [Cmdlet("New", "Me_Drive_Items_Workbook_Tables_Worksheet", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.workbookWorksheet")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    [ResourceReference]
    public class New_Me_Drive_Items_Workbook_Tables_Worksheet : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">PATCH ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet</para>
    ///     <para type="description">Updates the &quot;worksheet&quot; object (which is of type &quot;microsoft.graph.workbookWorksheet&quot;).</para>
    /// </summary>
    [Cmdlet("Update", "Me_Drive_Items_Workbook_Tables_Worksheet", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.workbookWorksheet")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    public class Update_Me_Drive_Items_Workbook_Tables_Worksheet : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
    ...
    ///     <para type="description">DELETE ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet</para>
    ///     <para type="description">Removes the &quot;worksheet&quot; object (which is of type &quot;microsoft.graph.workbookWorksheet&quot;).</para>
    /// </summary>
    [Cmdlet("Remove", "Me_Drive_Items_Workbook_Tables_Worksheet", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookWorksheet")]
    public class Remove_Me_Drive_Items_Workbook_Tables_Worksheet : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
    ...
    /// <summary>
    ///     <para type="description">POST ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/add</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Items_Workbook_Tables_Worksheet_Add", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.workbookWorksheet")]
    public class Invoke_Me_Drive_Items_Workbook_Tables_Worksheet_Add : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/add";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/cell</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Items_Workbook_Tables_Worksheet_Cell", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    public class Invoke_Me_Drive_Items_Workbook_Tables_Worksheet_Cell : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/cell({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/range</para>
    ///     <para type="description">The function &quot;microsoft.graph.range&quot;, which exists on the type &quot;microsoft.graph.workbookWorksheet&quot;.</para>
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Items_Workbook_Tables_Worksheet_Range", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    public class Invoke_Me_Drive_Items_Workbook_Tables_Worksheet_Range : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/range({this.GetFunctionUrlSegment()})";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/usedRange</para>
    ...
    ///     <para type="description">This function returns a &quot;microsoft.graph.workbookRange&quot; object.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_Drive_Items_Workbook_Tables_Worksheet_UsedRange", DefaultParameterSetName = @"Get")]
    [ODataType("microsoft.graph.workbookWorksheet")]
    public class Invoke_Me_Drive_Items_Workbook_Tables_Worksheet_UsedRange : FunctionReturningEntityCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.workbookTable&quot; object in the &quot;tables&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/drive/items/{itemId}/workbook/tables/{tableId}/worksheet/usedRange({this.GetFunctionUrlSegment()})";
        }
    }
}