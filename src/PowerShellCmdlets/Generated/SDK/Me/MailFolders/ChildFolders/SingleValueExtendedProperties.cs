...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/mailFolders/{mailFolderId}/childFolders/{childFolderId}/singleValueExtendedProperties</para>
    ...
    /// </summary>
    [Cmdlet("Get", "Me_MailFolders_ChildFolders_SingleValueExtendedProperties", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.singleValueLegacyExtendedProperty")]
    [ResourceIdPropertyName("singleValueExtendedPropertyId")]
    [ResourceReference]
    public class Get_Me_MailFolders_ChildFolders_SingleValueExtendedProperties : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/mailFolders/{mailFolderId}/childFolders/{childFolderId}/singleValueExtendedProperties/{singleValueExtendedPropertyId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a &quot;microsoft.graph.singleValueLegacyExtendedProperty&quot; object.</para>
    ///     <para type="description">POST ~/me/mailFolders/{mailFolderId}/childFolders/{childFolderId}/singleValueExtendedProperties</para>
    ...
    /// </summary>
    [Cmdlet("New", "Me_MailFolders_ChildFolders_SingleValueExtendedProperties", ConfirmImpact = ConfirmImpact.Low, DefaultParameterSetName = @"#microsoft.graph.singleValueLegacyExtendedProperty")]
    [ODataType("microsoft.graph.singleValueLegacyExtendedProperty")]
    [ResourceReference]
    public class New_Me_MailFolders_ChildFolders_SingleValueExtendedProperties : PostCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.mailFolder&quot; object in the &quot;childFolders&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/mailFolders/{mailFolderId}/childFolders/{childFolderId}/singleValueExtendedProperties";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Updates a &quot;microsoft.graph.singleValueLegacyExtendedProperty&quot;.</para>
    ///     <para type="description">PATCH ~/me/mailFolders/{mailFolderId}/childFolders/{childFolderId}/singleValueExtendedProperties</para>
    ...
    /// </summary>
    [Cmdlet("Update", "Me_MailFolders_ChildFolders_SingleValueExtendedProperties", ConfirmImpact = ConfirmImpact.Medium, DefaultParameterSetName = @"#microsoft.graph.singleValueLegacyExtendedProperty")]
    [ODataType("microsoft.graph.singleValueLegacyExtendedProperty")]
    [ResourceIdPropertyName("singleValueExtendedPropertyId")]
    public class Update_Me_MailFolders_ChildFolders_SingleValueExtendedProperties : PatchCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.singleValueLegacyExtendedProperty&quot; object in the &quot;singleValueExtendedProperties&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/mailFolders/{mailFolderId}/childFolders/{childFolderId}/singleValueExtendedProperties/{singleValueExtendedPropertyId}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Removes a &quot;microsoft.graph.singleValueLegacyExtendedProperty&quot; object.</para>
    ///     <para type="description">DELETE ~/me/mailFolders/{mailFolderId}/childFolders/{childFolderId}/singleValueExtendedProperties/singleValueExtendedPropertyId</para>
    ...
    /// </summary>
    [Cmdlet("Remove", "Me_MailFolders_ChildFolders_SingleValueExtendedProperties", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.singleValueLegacyExtendedProperty")]
    [ResourceIdPropertyName("singleValueExtendedPropertyId")]
    public class Remove_Me_MailFolders_ChildFolders_SingleValueExtendedProperties : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.singleValueLegacyExtendedProperty&quot; object in the &quot;singleValueExtendedProperties&quot; collection.</para>
        /// </summary>
