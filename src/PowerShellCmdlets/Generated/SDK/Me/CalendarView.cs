...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/me/calendarView</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.event&quot; objects in the &quot;calendarView&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "Me_CalendarView", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("calendarViewId")]
    [ResourceReference]
    public class Get_Me_CalendarView : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        {
            return $"me/calendarView/{calendarViewId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/calendarView/accept</para>
    ///     <para type="description">The action &quot;microsoft.graph.accept&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_CalendarView_Accept", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("calendarViewId")]
    public class Invoke_Me_CalendarView_Accept : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/{calendarViewId}/accept";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/calendarView/decline</para>
    ///     <para type="description">The action &quot;microsoft.graph.decline&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_CalendarView_Decline", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("calendarViewId")]
    public class Invoke_Me_CalendarView_Decline : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/{calendarViewId}/decline";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/calendarView/tentativelyAccept</para>
    ///     <para type="description">The action &quot;microsoft.graph.tentativelyAccept&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_CalendarView_TentativelyAccept", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("calendarViewId")]
    public class Invoke_Me_CalendarView_TentativelyAccept : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/{calendarViewId}/tentativelyAccept";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/calendarView/snoozeReminder</para>
    ///     <para type="description">The action &quot;microsoft.graph.snoozeReminder&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_CalendarView_SnoozeReminder", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("calendarViewId")]
    public class Invoke_Me_CalendarView_SnoozeReminder : ActionCmdlet
    {
        /// <summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/{calendarViewId}/snoozeReminder";
        }
    }

    /// <summary>
    ///     <para type="description">POST ~/me/calendarView/dismissReminder</para>
    ///     <para type="description">The action &quot;microsoft.graph.dismissReminder&quot;, which exists on the type &quot;microsoft.graph.event&quot;.</para>
    ///     <para type="description">This action does not return any objects.</para>
    /// </summary>
    [Cmdlet("Invoke", "Me_CalendarView_DismissReminder", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.event")]
    [ResourceIdPropertyName("calendarViewId")]
    public class Invoke_Me_CalendarView_DismissReminder : ActionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.event&quot; object in the &quot;calendarView&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/{calendarViewId}/dismissReminder";
        }
    }

    /// <summary>
    ///     <para type="description">GET ~/me/calendarView/delta</para>
    ...
    /// </summary>
    [Cmdlet("Invoke", "Me_CalendarView_Delta", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.event")]
    public class Invoke_Me_CalendarView_Delta : FunctionReturningCollectionCmdlet
    {
        internal override System.String GetResourcePath()
        {
            return $"me/calendarView/delta({this.GetFunctionUrlSegment()})";
        }
    }
}