...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    public class Get_DeviceManagement_DeviceCompliancePolicies_DeviceStatuses : GetOrSearchCmdlet
    {
        ...
        [Alias("id")]
        [ValidateNotNullOrEmpty]
        [Parameter(ParameterSetName = @"Get", ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.deviceComplianceDeviceStatus&quot; object in the &quot;deviceStatuses&quot; collection.")]
    ...
    public class New_DeviceManagement_DeviceCompliancePolicies_DeviceStatuses : PostCmdlet
    {
        ...
        internal override System.String GetResourcePath()
        {
            return $"deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicyId}/deviceStatuses";
        }
    }
