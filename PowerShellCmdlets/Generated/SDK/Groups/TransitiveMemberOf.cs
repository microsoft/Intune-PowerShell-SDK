...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    [Cmdlet("Get", "Groups_TransitiveMemberOf", DefaultParameterSetName = @"Search")]
    ...
    [ResourceTypePropertyName("transitiveMemberOfODataType")]
    public class Get_Groups_TransitiveMemberOf : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        [ResourceIdParameter]
        [ValidateNotNullOrEmpty]
        [Parameter(ParameterSetName = @"Get", Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;transitiveMemberOf&quot; collection.")]
        ...
        {
            return $"groups/{groupId}/transitiveMemberOf/{directoryObjectId ?? string.Empty}";
        }
    }
    ...
    /// </summary>
    /// <para type="link" uri="https://github.com/Microsoft/Intune-PowerShell-SDK">GitHub Repository</para>
    [Cmdlet("Get", "Groups_TransitiveMemberOfReferences", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.directoryObject", "microsoft.graph.administrativeUnit", "microsoft.graph.groupSettingTemplate", "microsoft.graph.user", "microsoft.graph.organization", "microsoft.graph.contract", "microsoft.graph.group", "microsoft.graph.directoryRoleTemplate", "microsoft.graph.directoryRole", "microsoft.graph.directoryObjectPartnerReference", "microsoft.graph.device")]
    [ResourceTypePropertyName("transitiveMemberOfODataType")]
    public class Get_Groups_TransitiveMemberOfReferences : GetOrSearchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.group&quot; object in the &quot;groups&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"groups/{groupId}/transitiveMemberOf/{directoryObjectId ?? string.Empty}/$ref";
        }
    }
    ...
    /// </summary>
    /// <para type="link" uri="https://github.com/Microsoft/Intune-PowerShell-SDK">GitHub Repository</para>
    [Cmdlet("New", "Groups_TransitiveMemberOfReferences", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("microsoft.graph.directoryObject", "microsoft.graph.administrativeUnit", "microsoft.graph.groupSettingTemplate", "microsoft.graph.user", "microsoft.graph.organization", "microsoft.graph.contract", "microsoft.graph.group", "microsoft.graph.directoryRoleTemplate", "microsoft.graph.directoryRole", "microsoft.graph.directoryObjectPartnerReference", "microsoft.graph.device")]
    [ResourceTypePropertyName("transitiveMemberOfODataType")]
    public class New_Groups_TransitiveMemberOfReferences : PostReferenceToCollectionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;transitiveMemberOf&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"groups/{groupId}/transitiveMemberOf/{directoryObjectId}/$ref";
        }
    ...
    /// </summary>
    /// <para type="link" uri="https://github.com/Microsoft/Intune-PowerShell-SDK">GitHub Repository</para>
    [Cmdlet("Remove", "Groups_TransitiveMemberOfReferences", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.directoryObject", "microsoft.graph.administrativeUnit", "microsoft.graph.groupSettingTemplate", "microsoft.graph.user", "microsoft.graph.organization", "microsoft.graph.contract", "microsoft.graph.group", "microsoft.graph.directoryRoleTemplate", "microsoft.graph.directoryRole", "microsoft.graph.directoryObjectPartnerReference", "microsoft.graph.device")]
    [ResourceTypePropertyName("transitiveMemberOfODataType")]
    public class Remove_Groups_TransitiveMemberOfReferences : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;transitiveMemberOf&quot; collection.</para>
        /// </summary>
        ...
        [ResourceIdParameter]
        [ValidateNotNullOrEmpty]
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;transitiveMemberOf&quot; collection.")]
        public System.String directoryObjectId { get; set; }
