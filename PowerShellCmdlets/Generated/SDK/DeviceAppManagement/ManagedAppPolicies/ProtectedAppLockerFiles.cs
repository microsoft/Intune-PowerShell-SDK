...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    public class Get_DeviceAppManagement_ManagedAppPolicies_ProtectedAppLockerFiles : GetOrSearchCmdlet
    {
        ...
        {
            return $"deviceAppManagement/managedAppPolicies/{managedAppPolicyId}/{managedAppPolicyODataType}/protectedAppLockerFiles/{protectedAppLockerFileId ?? string.Empty}";
        }
    }
    ...
    public class New_DeviceAppManagement_ManagedAppPolicies_ProtectedAppLockerFiles : PostCmdlet
    {
        ...
        internal override System.String GetResourcePath()
        {
            return $"deviceAppManagement/managedAppPolicies/{managedAppPolicyId}/{managedAppPolicyODataType}/protectedAppLockerFiles/{protectedAppLockerFileId}";
        }
    }
    ...
    ///     <para type="description">DELETE ~/deviceAppManagement/managedAppPolicies/{managedAppPolicyId}/{managedAppPolicyODataType}/protectedAppLockerFiles/protectedAppLockerFileId</para>
