...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    public class Get_DeviceAppManagement_MdmWindowsInformationProtectionPolicies_Assignments : GetOrSearchCmdlet
    {
        ...
        {
            return $"deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicyId}/{mdmWindowsInformationProtectionPolicyODataType}/assignments/{assignmentId ?? string.Empty}";
        }
    }
    ...
    public class New_DeviceAppManagement_MdmWindowsInformationProtectionPolicies_Assignments : PostCmdlet
    {
        ...
        internal override System.String GetResourcePath()
        {
            return $"deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicyId}/{mdmWindowsInformationProtectionPolicyODataType}/assignments/{assignmentId}";
        }
    }
    ...
    ///     <para type="description">DELETE ~/deviceAppManagement/mdmWindowsInformationProtectionPolicies/{mdmWindowsInformationProtectionPolicyId}/{mdmWindowsInformationProtectionPolicyODataType}/assignments/assignmentId</para>
