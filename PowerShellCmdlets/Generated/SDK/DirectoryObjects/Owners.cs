...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">GET ~/directoryObjects/{directoryObjectId}/{directoryObjectODataType}/owners</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.directoryObject&quot; objects in the &quot;owners&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "DirectoryObjects_Owners", DefaultParameterSetName = @"Search")]
    ...
    [ResourceIdPropertyName("ownerId")]
    public class Get_DirectoryObjects_Owners : GetOrSearchCmdlet
    {
        /// <summary>
        ...
        [Alias("id")]
        [ValidateNotNullOrEmpty]
        [Parameter(ParameterSetName = @"Get", Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;owners&quot; collection.")]
        ...
        {
            return $"directoryObjects/{directoryObjectId}/{directoryObjectODataType}/owners/{ownerId ?? string.Empty}";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Retrieves &quot;microsoft.graph.directoryObject&quot; object references.</para>
    ///     <para type="description">GET ~/directoryObjects/{directoryObjectId}/{directoryObjectODataType}/owners/$ref</para>
    ///     <para type="description">Retrieves &quot;microsoft.graph.directoryObject&quot; object references in the &quot;owners&quot; collection.</para>
    /// </summary>
    [Cmdlet("Get", "DirectoryObjects_OwnersReferences", DefaultParameterSetName = @"Search")]
    [ODataType("microsoft.graph.directoryObject", "microsoft.graph.administrativeUnit", "microsoft.graph.groupSettingTemplate", "microsoft.graph.user", "microsoft.graph.organization", "microsoft.graph.contract", "microsoft.graph.group", "microsoft.graph.directoryRoleTemplate", "microsoft.graph.directoryRole", "microsoft.graph.device")]
    [ResourceTypePropertyName("ownerODataType")]
    [ResourceIdPropertyName("ownerId")]
    public class Get_DirectoryObjects_OwnersReferences : GetOrSearchCmdlet
    {
        /// <summary>
        ///     <para type="description">A required ID for referencing a &quot;microsoft.graph.directoryObject&quot; object in the &quot;directoryObjects&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"directoryObjects/{directoryObjectId}/{directoryObjectODataType}/owners/{ownerId ?? string.Empty}/$ref";
        }
    }

    /// <summary>
    ///     <para type="synopsis">Creates a reference from a &quot;directoryObject&quot; to a &quot;microsoft.graph.directoryObject&quot; object.</para>
    ///     <para type="description">POST ~/directoryObjects/{directoryObjectId}/{directoryObjectODataType}/owners/$ref</para>
    ///     <para type="description">Creates a reference from the specified &quot;directoryObject&quot; object to a &quot;owner&quot;.</para>
    /// </summary>
    [Cmdlet("New", "DirectoryObjects_OwnersReferences", ConfirmImpact = ConfirmImpact.Low)]
    [ODataType("microsoft.graph.directoryObject", "microsoft.graph.administrativeUnit", "microsoft.graph.groupSettingTemplate", "microsoft.graph.user", "microsoft.graph.organization", "microsoft.graph.contract", "microsoft.graph.group", "microsoft.graph.directoryRoleTemplate", "microsoft.graph.directoryRole", "microsoft.graph.device")]
    [ResourceTypePropertyName("ownerODataType")]
    [ResourceIdPropertyName("directoryObjectReferenceUrl")]
    public class New_DirectoryObjects_OwnersReferences : PostReferenceToCollectionCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;owners&quot; collection.</para>
        /// </summary>
        ...
        internal override System.String GetResourcePath()
        {
            return $"directoryObjects/{directoryObjectId}/{directoryObjectODataType}/owners/{ownerId}/$ref";
        }
    ...
    ///     <para type="description">DELETE ~/directoryObjects/{directoryObjectId}/{directoryObjectODataType}/owners/ownerId/$ref</para>
    ///     <para type="description">Removes a reference from the specified &quot;directoryObject&quot; object to a &quot;owner&quot;.</para>
    /// </summary>
    [Cmdlet("Remove", "DirectoryObjects_OwnersReferences", ConfirmImpact = ConfirmImpact.High)]
    [ODataType("microsoft.graph.directoryObject", "microsoft.graph.administrativeUnit", "microsoft.graph.groupSettingTemplate", "microsoft.graph.user", "microsoft.graph.organization", "microsoft.graph.contract", "microsoft.graph.group", "microsoft.graph.directoryRoleTemplate", "microsoft.graph.directoryRole", "microsoft.graph.device")]
    [ResourceTypePropertyName("ownerODataType")]
    [ResourceIdPropertyName("ownerId")]
    public class Remove_DirectoryObjects_OwnersReferences : DeleteCmdlet
    {
        /// <summary>
        ///     <para type="description">The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;owners&quot; collection.</para>
        /// </summary>
        ...
        [Alias("id")]
        [ValidateNotNullOrEmpty]
        [Parameter(Mandatory = true, ValueFromPipeline = true, ValueFromPipelineByPropertyName = true, HelpMessage = @"The ID for a &quot;microsoft.graph.directoryObject&quot; object in the &quot;owners&quot; collection.")]
        public System.String ownerId { get; set; }
