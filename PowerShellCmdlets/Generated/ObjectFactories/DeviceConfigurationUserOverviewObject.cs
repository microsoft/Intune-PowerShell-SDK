...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    /// <summary>
    ///     <para type="synopsis">Creates a new object which represents a &quot;microsoft.graph.deviceConfigurationUserOverview&quot; (or one of it&apos;s derived types).</para>
    ///     <para type="description">Creates a new object which represents a &quot;microsoft.graph.deviceConfigurationUserOverview&quot; (or one of it&apos;s derived types).</para>
    /// </summary>
    [Cmdlet("New", "DeviceConfigurationUserOverviewObject", DefaultParameterSetName = @"microsoft.graph.deviceConfigurationUserOverview")]
    [ODataType("microsoft.graph.deviceConfigurationUserOverview")]
    public class New_DeviceConfigurationUserOverviewObject : ObjectFactoryCmdletBase
    {
        /// <summary>
