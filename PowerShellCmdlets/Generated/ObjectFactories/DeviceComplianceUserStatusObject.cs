...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    /// <summary>
    ///     <para type="synopsis">Creates a new object which represents a &quot;microsoft.graph.deviceComplianceUserStatus&quot; (or one of it&apos;s derived types).</para>
    ///     <para type="description">Creates a new object which represents a &quot;microsoft.graph.deviceComplianceUserStatus&quot; (or one of it&apos;s derived types).</para>
    /// </summary>
    [Cmdlet("New", "DeviceComplianceUserStatusObject", DefaultParameterSetName = @"microsoft.graph.deviceComplianceUserStatus")]
    [ODataType("microsoft.graph.deviceComplianceUserStatus")]
    public class New_DeviceComplianceUserStatusObject : ObjectFactoryCmdletBase
    {
        /// <summary>
