...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    /// <summary>
    ///     <para type="synopsis">Creates a new object which represents a &quot;microsoft.graph.deviceConfigurationDeviceStatus&quot; (or one of it&apos;s derived types).</para>
    ///     <para type="description">Creates a new object which represents a &quot;microsoft.graph.deviceConfigurationDeviceStatus&quot; (or one of it&apos;s derived types).</para>
    /// </summary>
    [Cmdlet("New", "DeviceConfigurationDeviceStatusObject", DefaultParameterSetName = @"microsoft.graph.deviceConfigurationDeviceStatus")]
    [ODataType("microsoft.graph.deviceConfigurationDeviceStatus")]
    public class New_DeviceConfigurationDeviceStatusObject : ObjectFactoryCmdletBase
    {
        /// <summary>
