...
namespace Microsoft.Intune.PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    /// <summary>
    ///     <para type="synopsis">Creates a new object which represents a &quot;microsoft.graph.deviceComplianceDeviceOverview&quot; (or one of it&apos;s derived types).</para>
    ///     <para type="description">Creates a new object which represents a &quot;microsoft.graph.deviceComplianceDeviceOverview&quot; (or one of it&apos;s derived types).</para>
    /// </summary>
    [Cmdlet("New", "DeviceComplianceDeviceOverviewObject", DefaultParameterSetName = @"#microsoft.graph.deviceComplianceDeviceOverview")]
    [ODataType("microsoft.graph.deviceComplianceDeviceOverview")]
    public class New_DeviceComplianceDeviceOverviewObject : ObjectFactoryCmdletBase
    {
        /// <summary>
